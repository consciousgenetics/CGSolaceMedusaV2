        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-list-64GCYLVE.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-create-4HCOAE26.mjs")
                  },
                  {
                    path: "import",
                  ...
                  {
                    path: "export",
                    lazy: () => import("./product-export-HWZBY424.mjs")
                  }
                ]
              },
              {
                ...
                errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
                lazy: async () => {
                  const { Breadcrumb, loader } = await import("./product-detail-7AUEIP6H.mjs");
                  return {
                    Component: Outlet4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./product-detail-7AUEIP6H.mjs"),
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./product-edit-5B5MRWUG.mjs")
                      },
                      {
                        path: "edit-variant",
                      ...
                      {
                        path: "sales-channels",
                        lazy: () => import("./product-sales-channels-N5ZMHH3A.mjs")
                      },
                      {
                        path: "attributes",
                        lazy: () => import("./product-attributes-HBFF4CXQ.mjs")
                      },
                      {
                        path: "organization",
                        lazy: () => import("./product-organization-X5LYKZSG.mjs")
                      },
                      {
                        path: "media",
                        lazy: () => import("./product-media-QHPJV6VH.mjs")
                      },
                      {
                        path: "prices",
                  ...
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component, Breadcrumb, loader } = await import("./product-variant-detail-IQHBMI7O.mjs");
                      return {
                        Component,
                        loader,
                        handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./category-list-7ZCBTGGC.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./category-detail-CVQVAUY5.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "products",
                    lazy: () => import("./category-products-TJRVLSGV.mjs")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-MWF2W2G6.mjs")
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./order-list-E243RNER.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./order-detail-OTLEGHMW.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "fulfillment",
                    lazy: () => import("./order-create-fulfillment-XVBHEB3C.mjs")
                  },
                  {
                  ...
                  },
                  {
                    ...
                    lazy: () => import("./order-create-shipment-DKICQUKW.mjs")
                  },
                  {
                    path: "returns",
                    lazy: () => import("./order-create-return-UT62BJW2.mjs")
                  },
                  {
                    path: "claims",
                    lazy: () => import("./order-create-claim-MRFJ32ZD.mjs")
                  },
                  {
                    path: "exchanges",
                    lazy: () => import("./order-create-exchange-JCPEMEMO.mjs")
                  },
                  {
                    path: "edits",
                    lazy: () => import("./order-create-edit-NRH3AMAN.mjs")
                  },
                  {
                    path: "refund",
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./promotion-list-RTEN3MGG.mjs")
              },
              {
                path: "create",
                lazy: () => import("./promotion-create-O3O4R5EO.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./promotion-detail-XGCFSTXH.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./campaign-list-IJDRFQVA.mjs"),
                children: []
              },
              {
                path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./campaign-detail-3RGSJQVY.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "add-promotions",
                    lazy: () => import("./add-campaign-promotions-KJ35AKIZ.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./collection-list-M4ZM5SIE.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./collection-detail-5EWWUQG4.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "products",
                    lazy: () => import("./collection-add-products-LHACHLHG.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./price-list-list-K4XCFHFQ.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./price-list-create-OXTWUXLH.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./price-list-detail-YMQW2HNE.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "configuration",
                    lazy: () => import("./price-list-configuration-XYIEEHKF.mjs")
                  },
                  {
                    path: "products/add",
                    lazy: () => import("./price-list-prices-add-75YC7XLQ.mjs")
                  },
                  {
                    path: "products/edit",
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-list-ROGECTTK.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./customer-detail-OFZOTU42.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    lazy: () => import("./customers-add-customer-group-WRYRK2V6.mjs")
                  },
                  {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-group-list-GQYVDRDV.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./customer-group-detail-BF3QXNCD.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "add-customers",
                    lazy: () => import("./customer-group-add-customers-IYOI5BDR.mjs")
                  },
                  {
                    path: "metadata/edit",
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./reservation-list-7ZUW2VPT.mjs"),
                children: [
                  {
                    path: "create",
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./inventory-list-M2LW36PS.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./inventory-detail-DDTWI6US.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "profile",
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./profile-detail-WD5VVF7J.mjs"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./profile-edit-XJXG5XT2.mjs")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./region-list-DRNID72M.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./region-create-GSB4TIBT.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./region-detail-WNBTFYI2.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "countries/add",
                    lazy: () => import("./region-add-countries-QLNG4IDL.mjs")
                  },
                  {
                    path: "metadata/edit",
          ...
          },
          {
            path: "store",
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./store-detail-6CT2RBJJ.mjs"),
            handle: {
            ...
            children: [
              ...
              {
                path: "currencies",
                lazy: () => import("./store-add-currencies-5YSZXK2C.mjs")
              },
              {
                path: "metadata/edit",
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./user-list-B4PDRYSR.mjs"),
                children: [
                  {
                    path: "invite",
                    lazy: () => import("./user-invite-AGABXOZ7.mjs")
                  }
                ]
              },
              {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./sales-channel-list-RFCO4CFE.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./sales-channel-detail-3BIGUVTF.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "add-products",
                    lazy: () => import("./sales-channel-add-products-LRH3WNRN.mjs")
                  },
                  {
                    path: "metadata/edit",
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./location-list-MVIHQUJU.mjs")
              },
              {
                path: "create",
              ...
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./shipping-profiles-list-O4PBEL2U.mjs"),
                    children: [
                      {
                        path: "create",
              ...
              },
              {
                path: ":location_id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./location-detail-IJISBV2S.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "sales-channels",
                    lazy: () => import("./location-sales-channels-E4LNVTJT.mjs")
                  },
                  {
                    path: "fulfillment-providers",
                    lazy: () => import("./location-fulfillment-providers-ZKMJ5MOF.mjs")
                  },
                  {
                    ...
                    children: [
                      {
                        ...
                        lazy: () => import("./location-service-zone-create-F7ZJUOA5.mjs")
                      },
                      {
                        ...
                        children: [
                          ...
                          {
                            path: "areas",
                            lazy: () => import("./location-service-zone-manage-areas-PJFPACGE.mjs")
                          },
                          {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-tag-list-U75623AK.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./product-tag-detail-CVMIZTGJ.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./workflow-execution-list-RQDXV6U7.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-type-list-2R7XVCPG.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./product-type-detail-WARA4WII.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./api-key-management-list-UH6HKKQX.mjs"),
                    children: [
                      {
                        path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./api-key-management-detail-GZV4I6H5.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "sales-channels",
                    lazy: () => import("./api-key-management-sales-channels-63WBR6TN.mjs")
                  }
                ]
              }
            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./tax-region-list-B4TQLH7P.mjs"),
                children: [
                  {
                    path: "create",
                ...
                children: [
                  {
                    path: "",
                    lazy: async () => {
                      const { Component } = await import("./tax-region-detail-O25MAHS3.mjs");
                      return {
                        Component
                      };
                    },
                    children: [
                      ...
                      },
                      {
                        ...
                        lazy: () => import("./tax-region-tax-override-create-VLJKHTWN.mjs")
                      },
                      {
                        path: "overrides/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-override-edit-DPGPYZJA.mjs")
                      },
                      {
                  ...
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component, Breadcrumb, loader } = await import("./tax-region-province-detail-B7WJTAPI.mjs");
                      return {
                        Component,
                        loader,
                        handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./return-reason-list-AZ3Q6MJY.mjs"),
                children: [
                  {
                    path: "create",
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "/reset-password",
            lazy: () => import("./reset-password-BS6VKSLH.mjs")
          },
          {
            path: "/invite",
