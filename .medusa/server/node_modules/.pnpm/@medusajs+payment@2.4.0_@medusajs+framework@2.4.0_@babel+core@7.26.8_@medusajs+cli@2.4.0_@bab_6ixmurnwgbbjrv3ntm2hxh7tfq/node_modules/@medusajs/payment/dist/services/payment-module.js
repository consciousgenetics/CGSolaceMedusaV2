...
class PaymentModuleService extends utils_1.ModulesSdkUtils.MedusaService(generateMethodForModels) {
    ...
    async listPaymentMethods(filters, config = {}, sharedContext) {
        const res = await this.paymentProviderService_.listPaymentMethods(filters.provider_id, filters.context);
        return res.map((item) => ({
            id: item.id,
            data: item.data,
    ...
    async listAndCountPaymentMethods(filters, config = {}, sharedContext) {
        const paymentMethods = await this.paymentProviderService_.listPaymentMethods(filters.provider_id, filters.context);
